...
import { ProductAnalytics } from '@/components/views/product-analytics';
...
export default function ProductAnalyticsPage() {
    ...
    return (
      <div className="flex items-center justify-center h-[60vh]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-xs font-black text-gray-500 uppercase tracking-widest">Loading analytics…</p>
        </div>
      </div>
    );
  }
  ...
  return <ProductAnalytics product={product} onBack={() => router.push('/inventory')} />;
}
